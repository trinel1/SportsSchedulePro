...
namespace SportsScheduleProLibrary.Migrations
{
    ...
    [Migration("20250126053640_ExcludeGameDate")]
    partial class ExcludeGameDate
    {
            ...
            modelBuilder.Entity("SportsScheduleProLibrary.Models.Alert", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AlertId = 1,
                            AlertDate = new DateTime(2025, 1, 25, 23, 36, 39, 637, DateTimeKind.Local).AddTicks(3709),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SportsScheduleProLibrary.Models.ExcludedGameDate", b =>
                {
                    ...
                    b.Property<DateTime?>("ExcludedTime")
                        .HasColumnType("TEXT");
