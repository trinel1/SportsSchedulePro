...
namespace SportsScheduleProLibrary.Migrations
{
    ...
    [Migration("20250904194510_FieldUpdates")]
            ...
            modelBuilder.Entity("SportsScheduleProLibrary.Models.Alert", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AlertId = 1,
                            AlertDate = new DateTime(2025, 9, 4, 14, 45, 9, 664, DateTimeKind.Local).AddTicks(5645),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SportsScheduleProLibrary.Models.Field", b =>
                {
                    ...
                    b.Property<int>("FieldGameLengthWindow")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EarliestGameTimeHourSaturday = 8,
